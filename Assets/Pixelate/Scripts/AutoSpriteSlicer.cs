...
{
    public static void Slice(Texture2D texture, Vector2 cellSize, Vector2 pivot, bool slice)
    {
        ProcessAnimation(texture, cellSize, pivot, slice);
        ProcessAnimation(texture, cellSize, pivot, slice);
    }


    static void ProcessAnimation(Texture2D texture, Vector2 cellSize, Vector2 pivot, bool slice)
    {
